...
export class InitCombatServiceDB1763728830142 implements MigrationInterface {
    name = 'InitCombatServiceDB1763728830142'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "duels" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "character_one_id" uuid NOT NULL, "lastAttackCharacterOneAt" TIMESTAMP WITH TIME ZONE, "lastCastCharacterOneAt" TIMESTAMP WITH TIME ZONE, "lastHealCharacterOneAt" TIMESTAMP WITH TIME ZONE, "character_two_id" uuid NOT NULL, "lastAttackCharacterTwoAt" TIMESTAMP WITH TIME ZONE, "lastCastCharacterTwoAt" TIMESTAMP WITH TIME ZONE, "lastHealCharacterTwoAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_a1587a65a7f5d55bd7efd7e1cd2" UNIQUE ("name"), CONSTRAINT "PK_138743a525868817b14d09a0d3e" PRIMARY KEY ("id"))`);
